...
var sum = add(firstBang, secondBang);
console.log(sum);
...
var difference = subtract(firstBang, secondBang);
...
var quotient = divide(firstBang, secondBang);
...
var myFullName = createFullName("Gagan", "Tut");
...
console.log(eatFood("Gagan", "Tut", "pizza"));
